...
const ConversationPage = () => {
    ...
    const [userPrompt, setUserPrompt] = useState<string | null>(null); // New state to store user prompt
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            setMessages(response.data.message); // Set AI response
            setUserPrompt(values.prompt); // Set user prompt
